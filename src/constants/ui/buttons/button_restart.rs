...
pub const GAME_OVER_RESTART_BUTTON_WIDTH: Val = Val::VMax(6.8);

/// Height of the restart button in the game over panel.
pub const GAME_OVER_RESTART_BUTTON_HEIGHT: Val = Val::VMax(6.8);

/// Max width of the restart button in the game over panel.
pub const GAME_OVER_RESTART_BUTTON_MAX_WIDTH: Val = Val::Px(80.);

/// Max height of the restart button in the game over panel.
pub const GAME_OVER_RESTART_BUTTON_MAX_HEIGHT: Val = Val::Px(80.);
